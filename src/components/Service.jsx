    ...
    <section id="service" className="p-10 bg-sky-900">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className='md:relative'>
          ...
          <div className='bg-slate-600 bg-opacity-75 md:absolute md:top-40 md:bottom-0 p-2'>
        ...
        <div className='md:relative'>
          <figure>
            <img src="/assets/photo-1467232004584-a241de8bcf5d.avif" />
          </figure>
          <div className='bg-slate-600 bg-opacity-75 md:absolute top-40 bottom-0 p-2'>
        ...
        <div className='md:relative'>
          <figure>
            <img src="/assets/photo-1611926653458-09294b3142bf.avif"/>
          </figure>
          <div className='bg-slate-600 bg-opacity-75 md:absolute top-40 bottom-0 p-2'>
